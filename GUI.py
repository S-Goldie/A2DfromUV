...
btn8 = tk.Button(root, text="Absorption", command = function_name8,activebackground="green",bg = "lightblue",height=2,font=12,width=18,relief="groove")
btn8.pack()

btn9 = tk.Button(root, text="Extiction", command = function_name9,activebackground="green",bg = "lightblue",height=2,font=12,width=18,relief="groove")
btn9.pack()

btn10 = tk.Button(root, text="Next Step", command=function_quite,bg = "red",height=2,font=12,width=18,relief="groove")
btn10.pack()
root.mainloop()

print(material,methode)
